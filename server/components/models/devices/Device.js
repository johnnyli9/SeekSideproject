/**
 * Each device is deployed in a physical location
 */
"use strict";
            ...
            Public: {
                registerDevice: function(name) {
                    ...
                    .then(function(newUser) {
                        ...
                        return this.devices.createObject(newDevice);
                    });
                },
                ...
                resetDevice: function(deviceId) {
                    ...
                    .then(function(device) {
                        ...
                        return this.devices.updateObject(device);
                    });
                }
            }
        };
