        ...
        return {
            ...
            Public: {
                tryLogin: function(authData) {
                    ...
                    var deviceCache = this.Instance.Device.devices;
    ...
    Client: NoGapDef.defClient(function(Tools, Instance, Context) {
        ...
        return {
            ...
            onDeviceReady: function() {
                ...
                Instance.DeviceSeek.startSeeking(this.getCurrentDevice());
            },
